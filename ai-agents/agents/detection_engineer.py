...
class CoverageGapTool(BaseTool):
    ...
    def _run(self, tactic: str = "all") -> str:
        ...
        covered = {
            ...
            "T1566.001": "ElastAlert + Sigma (Initial Access - Spearphishing Attachment)",
            "T1039":     "ElastAlert + Sigma (Collection - Bulk File Access)",
            "T1078":     "ElastAlert + Sigma (Defense Evasion - After-Hours Logon)",
        }
        ...
        if tactic != "all":
            tactic_map = {
                ...
                "defense-evasion": ["T1562.001", "T1070.004", "T1027", "T1078"],
